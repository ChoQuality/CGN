...
@Controller
@RequestMapping("/ai/view")
public class AiMainViewController {

    private final LayoutService layoutService;
    private final AiService aiService;


    public AiMainViewController(Function<ContextType, LayoutService> layoutService, AiService aiService) {
    ...
    public String mainView(@AuthenticationPrincipal AWPUser user, Model model, Locale locale) {
        ...
        this.layoutService.setContextScripts("context/ai/script/main/mainScript");
        this.layoutService.setContextContent("context/ai/content/main/content_main");
