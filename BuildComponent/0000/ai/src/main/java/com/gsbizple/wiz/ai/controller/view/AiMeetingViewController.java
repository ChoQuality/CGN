...
@Controller
@RequestMapping("/ai/view/meeting")
public class AiMeetingViewController {

    private final LayoutService layoutService;
    private final AiService aiService;


    public AiMeetingViewController(Function<ContextType, LayoutService> layoutService, AiService aiService) {
    ...
    public String mainView(@AuthenticationPrincipal AWPUser user, Model model, Locale locale) {
        ...
        this.layoutService.setContextScripts("context/ai/script/meeting/mainScript");
        this.layoutService.setContextContent("context/ai/content/meeting/content_meeting");
        this.layoutService.setContextSub("context/ai/sub/meeting/sub");
