...
@Controller
@RequestMapping("/ai/view/rfp")
public class AiRfpViewController {

    private final LayoutService layoutService;
    private final AiService aiService;


    public AiRfpViewController(Function<ContextType, LayoutService> layoutService, AiService aiService) {
        this.layoutService = layoutService.apply(ContextType.AI);
    ...
    public String mainView(@AuthenticationPrincipal AWPUser user, Model model, Locale locale) {
        ...
        this.layoutService.setContextScripts("context/ai/script/rfp/mainScript");

        this.layoutService.setContextContent("context/ai/content/rfp/content_rfp");
        this.layoutService.setContextSub("context/ai/sub/rfp/sub");
