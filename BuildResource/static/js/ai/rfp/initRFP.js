...
class ChatMessageBuilder {
    ...
    static createDorothyMessage(question, response) {
        const wrapper = document.createElement("div");
        ...
        // 답변 박스 생성
        const replyBox = this.createReplyBox(question);
    ...
    static createReplyBox(question) {
        ...
        replyBody.innerHTML = UIUtils.sanitizeHTML(question);
...
class ChatService {
    constructor(formData, systemPromptManager) {
        ...
        this.apiUrl = window.location.origin + '/ai/api/rfp/question';
        this.init();
    }
    ...
    displayMessages(question, response) {
        ...
        const dorothyMessage = ChatMessageBuilder.createDorothyMessage(question, response);
